...
## [[3.25.1](https://github.com/nf-core/rnaseq/releases/tag/3.25.1)] - 2026-04-26
...
- [PR #XXXX](https://github.com/nf-core/rnaseq/pull/XXXX) - Disambiguate the three FastQC instances (raw / trimmed / filtered) in MultiQC General Statistics by suffixing each instance's column titles with `(raw)`, `(trim)` and `(filt)` ([#1828](https://github.com/nf-core/rnaseq/issues/1828))
