...
include { STAR_ALIGN as STAR_ALIGN_LEGACY            } from '../../../modules/nf-core/star/align'
...
workflow ALIGN_STAR {
    ...
    use_legacy_star      // boolean: whether to use legacy-pinned STAR (2.6.1d) for indices flagged as such in the genomes map
    ...
    } else if (use_legacy_star) {

        STAR_ALIGN_LEGACY(reads, index, gtf, star_ignore_sjdbgtf)
        ch_star_out = STAR_ALIGN_LEGACY
